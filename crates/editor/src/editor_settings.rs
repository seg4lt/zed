...
pub use settings::{
    CodeLens, CompletionDetailAlignment, CurrentLineHighlight, CursorTailProfile, DelayMs,
    DiffViewStyle, DisplayIn, DocumentColorsRenderMode, DoubleClickInMultibuffer,
    GoToDefinitionFallback, GoToDefinitionScrollStrategy, HideMouseMode, MinimapThumb,
