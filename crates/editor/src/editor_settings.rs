...
pub use settings::{
    CodeLens, CompletionDetailAlignment, CompletionMenuItemKind, CurrentLineHighlight,
    CursorTailProfile, DelayMs, DiffViewStyle, DisplayIn, DocumentColorsRenderMode,
